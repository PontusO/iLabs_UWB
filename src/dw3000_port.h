...
#if defined(ARDUINO_CHALLENGER_2040_UWB_RP2040)
#define DEFAULT_WAKE    15
#define DEFAULT_IRQ     14
#define DEFAULT_RST     13
#define DEFAULT_SS      9
#else
#define DEFAULT_WAKE    15
...
void softReset();
void idle();
void spiBegin(uint8_t irq = DEFAULT_IRQ, uint8_t rst = DEFAULT_RST, uint8_t wake = DEFAULT_WAKE);
void spiSelect(uint8_t ss = DEFAULT_SS);
...
void port_set_dw_ic_spi_fastrate(uint8_t irq = DEFAULT_IRQ, uint8_t rst = DEFAULT_RST, uint8_t ss = DEFAULT_SS, uint8_t wake = DEFAULT_WAKE);
